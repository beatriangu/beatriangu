<h1 align="center">Hi 👋, I'm Bea!..a just graduate of the first ZIP promotion .
## My Experience at 42 Urduliz
...
One year, 2160 hours, 22 projects submitted, 57 evaluations given, 50 received, and one exam passed (...thanks to jmedina coaching!!) later, I have managed to top it all off with my final Django project.

This achievement wouldn't have been possible without the help of Xabi Matute (Supercrack junior from 42), who guided me to find the right spot to place "Daphne the Petarda" among the apps in the `settings.py` configuration... and magic happened! 😊 

I also want to thank each and every one of my peers (...there aren’t enough letters in the alphabet to name them all, but they are all in the students directory of sgoinfre for sure!) for their support, patience, and help. 🙏 Because at 42, you are nothing alone. It's about people, thinking brains, endless paths, diverse solutions, but above all, a passion for helping, sharing, and learning from others. There's a well-deserved rush when you finish a project, and even more so when others do.

I want to express my gratitude to all the people who have evaluated me, and in the final stage, to those 31 transcended ones, so poorly hidden on the 8th floor or behind their screens, but always with a smile, willing to evaluate me and even eager to teach me new things! 😊 
